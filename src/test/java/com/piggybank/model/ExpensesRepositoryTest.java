...
public class ExpensesRepositoryTest {
  ...
  public void shouldCallFilterByDateStartAndDateEnd() {
    ...
    List<com.piggybank.expenses.dto.Expense> result =
  ...
  public void shouldSaveTheExpense() {
    ...
    Expense result =
        sut.save(
            com.piggybank.expenses.dto.Expense.newBuilder()
                .setAmount(123L)
  ...
  private com.piggybank.expenses.dto.Expense fakeDtoExpense(
      String description, ExpenseType expenseType, LocalDate date) {
    return com.piggybank.expenses.dto.Expense.newBuilder()
        .setAmount(100L)
        .setDescription(description)
        .setType(expenseType)
        .setDate(date)
